                    ...
                    {industries.map((industry, index) => (
                        <Link key={industry.name} href={industry.href}>
                            <motion.div
                                ...
                                whileHover={{ y: -8 }}
                                className="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 cursor-pointer h-full"
                            >
